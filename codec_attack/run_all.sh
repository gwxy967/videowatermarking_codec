...
# =================================================================
# VideoShield Master Attack Script (With Timing Stats)
# =================================================================

# 1. Input root directory
INPUT_ROOT_DIR="/home/david/videomarking/GAN/output_rivagan_batch/"
# 2. Output directory
OUTPUT_ROOT_DIR="/home/david/videomarking/codec/GAN_time_result/"
# 3. Report file path
...
# --- [NEW] Pre-calculate total file count ---
echo "Calculating total files in input directory..."
# Count files with common video extensions
...
for config in "${CONFIGS[@]}"; do
    ...
    # --- [NEW] Record end time and calculate duration ---
    end_time=$(date +%s)
    ...
    # Use awk to calculate average time (keep 2 decimal places)
